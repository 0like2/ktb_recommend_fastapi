...
from src.profile.schemas import ProfileEvaluationRequestDto, ProfileEvaluationResponseDto
from src.profile.methods.evaluation_methods import screenshot_evaluation

from src.profile.prompt_enum import EvaluationPrompt
